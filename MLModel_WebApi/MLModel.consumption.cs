...
public partial class MLModel
{
    ...
    public class ModelOutput
    {
        ...
        [ColumnName(@"Cidade")]
        public float[] Cidade { get; set; }

        [ColumnName(@"Plano")]
        public uint Plano { get; set; }
    ...
    private static IEnumerable<string> GetLabels(ModelOutput result)
    {
        ...
        var labelColumn = schema.GetColumnOrNull("Plano");
        if (labelColumn == null)
        {
            throw new Exception("Plano column not found. Make sure the name searched for matches the name in the schema.");
        }
